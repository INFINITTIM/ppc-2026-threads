...
// ============================================================================
// Вспомогательные функции (низкая когнитивная сложность)
// ============================================================================
...
// ============================================================================
// Параллельная версия (теперь простая — только оркестрация)
// ============================================================================
...
void ChernovTRadixSortSTL::RadixSortLSDParallel(std::vector<int> &data, int num_threads) {
  ...
  // Фаза 2: 4 прохода поразрядной сортировки
